...
actual fun createLocaleOptions(): List<LocaleOption> = listOf(
    LocaleOption("English", Locale.ENGLISH),
    LocaleOption("Français (French)", Locale.FRENCH),
    LocaleOption("Polski (Polish)", Locale.Builder().setLanguage("pl").setRegion("PL").build()),
    LocaleOption("Română (Romanian)", Locale.Builder().setLanguage("ro").setRegion("RO").build()),
